...
class IRRExplorerData(prefix_meta.Data):
    ...
    def _augment_route_objects(self, route_objects, prefix):
        """
    ...
    def route_objects(self):
        ...
        for entry in self.data:
            for _, routes in entry.get("irrRoutes", {}).items():
                collected_routes += self._augment_route_objects(routes, entry["prefix"])
